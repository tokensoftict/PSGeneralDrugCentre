        ...
        <div class="card-body">
            <div class="col-6 offset-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" wire:model.defer="store.branch_name"  class="form-control" name="branch_name" placeholder="Branch Name"/>
                ...
                <div class="mb-3">
                    ...
                    <input  type="number"  wire:model.defer="store.retail_threshold_days"  required class="form-control" name="retail_" placeholder="Threshold Days"/>
                    @error('store.retail_threshold_days') <span class="text-danger">{{ $message }}</span> @enderror
                </div>

                <div class="mb-3">
                    <label>Retail NOS Lead Time</label>
                    <input  type="number" wire:model.defer="store.retail_supply_days" required class="form-control" name="retail_supply_days" placeholder="Number Of Days to Supply"/>
                    @error('store.retail_supply_days') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
                <div class="mb-3">
                    <label>Retail Quantity to Buy Threshold</label>
                    <input  type="number" step="0.000001" wire:model.defer="store.retail_qty_to_buy_threshold" required class="form-control" name="retail_qty_to_buy_threshold" placeholder="Quantity to Buy Threshold"/>
                    @error('store.retail_qty_to_buy_threshold') <span class="text-danger">{{ $message }}</span> @enderror
                </div>

                <div class="mb-3">
                    <label>Near Expiry Days</label>
                    <input  type="number"  wire:model.defer="store.near_expiry_days" required class="form-control" name="near_expiry_days" placeholder="Near Expiry Days"/>
                ...
                <div class="mb-3">
                    ...
                    <input  type="number"  wire:model.defer="store.moving_stocks_constant" required class="form-control" name="moving_stocks_constant" placeholder="Moving Stock Constant 1"/>
                ...
                <div class="mb-3">
                    ...
                    <input  type="number"  wire:model.defer="store.moving_stocks_constant2" required class="form-control" name="moving_stocks_constant2" placeholder="Moving Stock Constant 2"/>
