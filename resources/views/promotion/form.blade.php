...
@section('pageHeaderTitle1', 'Create New Promotion')
@section('pageHeaderDescription', 'Create Promo Price for any items');
...
@section('content')
    ...
    <livewire:promotion.new-promotion :promotion="$promotion"/>
