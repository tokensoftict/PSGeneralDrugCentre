    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('stock_id')
            ->addColumn('name', function (Stockbatch $batch){
                return $batch->stock->name;
            })
            ->addColumn('from_qty')
            ->addColumn('to_qty')
            ->addColumn('result_minus')
            ->addColumn('result')
            ->addColumn('qty_to_move', function (Stockbatch $batch){
    ...
    public function header(): array
    {
        return [
            Button::add('bulk-delete')
                ->caption(__('Export To Transfer <i class="fa fa-arrow-right"></i>'))
                ->class('btn btn-success')
                ->emit('exportToTransfer', []),
        ];
    }
